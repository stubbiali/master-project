...
\begin{document}
	...
	\begin{center}
		...
		\begin{figure}[H]
			\center
			\includegraphics[scale = 1.1, trim = {0 2.5cm 0 2cm}, clip]{polimi}
		\end{figure}
		
		\vspace*{-0.3cm}
		
		\fontsize{15}{20}\selectfont{Politecnico di Milano} \\ 
		\fontsize{15}{20}\selectfont{Dipartimento di Matematica "F. Brioschi"} \\
	
		\vspace*{0.85cm}
		
		\begin{figure}[H]
			\center
			\includegraphics[scale = 1.1]{EPFL-Logo-CMJN} 
		\end{figure}
		
		\vspace*{-0.1cm}
	
		\fontsize{15}{20}\selectfont{\'Ecole Polytechnique F\'ed\'erale de Lausanne} \\ 
		\fontsize{15}{20}\selectfont{Chair of Computational Mathematics and Simulation Science} \\
		...
		\fontsize{25}{30}\selectfont{\textbf{Reduced order modeling of}} \\
		\fontsize{25}{30}\selectfont{\textbf{nonlinear problems}} \\ 
		\fontsize{25}{30}\selectfont{\textbf{using neural networks}} \\
		...
		\begin{minipage}{0.45\textwidth}
			%\vspace*{-2.85cm}
			\begin{center}
				\fontsize{17}{22}\selectfont{\emph{Candidate}} \\
		...
		\begin{minipage}{0.45\textwidth}
			\begin{center}
				\fontsize{17}{22}\selectfont{\emph{Supervisors}} \\
		...
		\fontsize{17}{22}\selectfont{A.Y. 2016 - 2017} 		
	\end{center}
	...
	\label{section:A POD-based RB method using neural networks}
		...
		\begin{figure}[t]
			...
			\begin{minipage}{0.4\textwidth}
				\center
				\includegraphics[scale = 0.7, trim = {0.5cm 0.5cm 0 1cm}, clip]{domain_stenosis}
			\end{minipage}
			\hfill
			\begin{minipage}{0.55\textwidth}
				\center
			...
			\begin{algorithmic}[1]
				\Function{$\left( \mathcal{N}^{opt}, \, \mathcal{V}^{opt}, \, \mathbf{w}^{opt} \right) = $ \\ \hspace*{0.5cm} PODNN\_training}{$\, \mathbb{V}$, $\varepsilon$, $N_{tr}^{max}$, $H^{max}$, $N_{te}$, $d$, $K_{ms}$, $\delta$, $T$, $K_{ea}$}
					...
					\DoWhile
						...
						\State $E_{\texttt{NN}}^{opt} = \infty$, $H = H_0$
						\While{$H \leq H^{max}$ and $E_{te} < E_{te}^{old}$}
							...
							\If{$E_{\texttt{NN}} < E_{\texttt{NN}}^{opt}$}
								\State $E_{\texttt{NN}}^{opt} = E_{\texttt{NN}}$, ~ $\mathcal{N}^{opt} = \mathcal{N}$, ~ $\mathcal{V}^{opt} = \mathcal{V}$, ~ $\mathbf{w}^{opt} = \mathbf{w}$

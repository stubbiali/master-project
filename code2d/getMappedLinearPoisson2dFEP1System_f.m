% getMappedLinearPoisson2dFEP1System_f Build stiffness matrix and right-hand 
...
% reference, unit square. "f" stands for "fast" since persistent variables
% are used to save variables between consecutive calls.
%
% [A, rhs] = getMappedLinearPoisson2dFEP1System_f(geometry, domain, mesh, ...
...
function [stif, rhs] = getMappedLinearPoisson2dFEP1System_f(geometry, domain, mesh_r, ...
    K, f, BCs_t, BCs_v, BCe_t, BCe_v, BCn_t, BCn_v, BCw_t, BCw_v) 
    % Declare persistent variables
    persistent pr1 pr2 pr3 pr4
    % Shortcuts

% LinearPoisson1dFEP1 Linear finite elements (FE-P1) solver for the linear 
...
% [x, alpha] = LinearPoisson1dFEP1(a, b, K, f, BCLt, BCLv, BCRt, BCRv, UL)
% [x, u, alpha] = LinearPoisson1dFEP1(a, b, K, f, BCLt, BCLv, BCRt, BCRv, UL)
%

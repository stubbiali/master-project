...
%
% [x, Y, UL] = getLinearPoisson1d1pSVDreducedBasis(mu1, mu2, N, L, solver, a, b, K, f, BCLt, BCLv, BCRt, BCRv)
...
%               reduced basis
function [x, mu, Y, UL] = getLinearPoisson1d1pSVDreducedBasis(mu1, mu2, N, L, solver, a, b, K, f, BCLt, BCLv, BCRt, BCRv)

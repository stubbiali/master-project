% LinearPoisson1dFEP1_f Linear finite elements (FE-P1) solver for the linear 
...
%
% [x, u] = LinearPoisson1dFEP1_f(a, b, K, f, BCLt, BCLv, BCRt, BCRv)
% [x, alpha] = LinearPoisson1dFEP1_f(a, b, K, f, BCLt, BCLv, BCRt, BCRv, UL)
% [x, u, alpha] = LinearPoisson1dFEP1_f(a, b, K, f, BCLt, BCLv, BCRt, BCRv, UL)
%
...
function [x, varargout] = LinearPoisson1dFEP1_f(a, b, K, f, BCLt, BCLv, BCRt, BCRv, varargin)
    ...
    if ~iscell(f)
        ...
        rhs = zeros(K,N);
        for i = 1:N
            rhs(:,i) = getLinearPoisson1dFEP1rhs_f(a, b, K, f{i}, BCLt, BCLv, BCRt, BCRv);
        end
    end

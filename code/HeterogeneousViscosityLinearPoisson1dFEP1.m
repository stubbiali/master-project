% HeterogeneousViscosityLinearPoisson1dFEP1 Linear finite elements (FE-P1) 
...
%
% [x, u] = HeterogeneousViscosityLinearPoisson1dFEP1(a, b, K, v, f, ...
%   BCLt, BCLv, BCRt, BCRv)
% [x, alpha] = HeterogeneousViscosityLinearPoisson1dFEP1(a, b, K, v, f, ...
%   BCLt, BCLv, BCRt, BCRv, UL)
% [x, u, alpha] = HeterogeneousViscosityLinearPoisson1dFEP1(a, b, K, v, f, ...
%   BCLt, BCLv, BCRt, BCRv, UL)
%
...
function [x, varargout] = HeterogeneousViscosityLinearPoisson1dFEP1(a, b, K, ...
    v, f, BCLt, BCLv, BCRt, BCRv, varargin)
    ...
    if ~iscell(f)
        ...
        rhs = zeros(K,N);
        for i = 1:N
            rhs(:,i) = getLinearPoisson1dFEP1rhs(a, b, K, f{i}, ...
                BCLt, BCLv, BCRt, BCRv);
        end
    end
